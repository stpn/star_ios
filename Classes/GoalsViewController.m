...
- (IBAction)refresh {
    ...
    [HRRestModel getPath:@"/stars" withOptions:nil object:nil];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView 
    ...
    cell.textLabel.text = goal.star_id;
    cell.detailTextLabel.text = goal.user_id;
...
commitEditingStyle:(UITableViewCellEditingStyle)editingStyle 
 forRowAtIndexPath:(NSIndexPath *)indexPath {
    if (editingStyle == UITableViewCellEditingStyleDelete) { 
        ...
        Goal *goal = [goals objectAtIndex:indexPath.row];
        [HRRestModel deletePath:[NSString stringWithFormat:@"stars/%@", goal.star_id]
...
- (void)restConnection:(NSURLConnection *)connection 
    ...
    if (isDeleting) {
        ...
        for (NSDictionary *dictionary in resource) {
            Goal *remoteGoal = [[Goal alloc] initWithDictionary:[dictionary objectForKey:@"star"] ];
